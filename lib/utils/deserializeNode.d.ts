...
export declare const deserializeNode: (data: SerializedNode, resolver: Record<string, string | React.ComponentClass<any, any> | React.FunctionComponent<any>>) => Pick<NodeData, "type" | "name" | "props" | "displayName" | "isCanvas" | "parent" | "index" | "linkedNodes" | "nodes" | "hidden" | "custom" | "_childCanvas">;
export {};
