...
export declare const deserializeNode: (data: SerializedNode, resolver: Record<string, string | React.ComponentClass<any, any> | React.FunctionComponent<any>>) => Pick<NodeData, "linkedNodes" | "type" | "name" | "props" | "displayName" | "isCanvas" | "parent" | "index" | "nodes" | "hidden" | "custom" | "_childCanvas">;
export {};
